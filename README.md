...
|----------------------------|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `additionalJlinkArgs`      | :x:                | `[]`                                                                                                                                               | Additional arguments passed to `jlink` when generating a customized JRE, e.g. `--include-locales=en,es`.                                                                                  |
...
| `jlinkCompression`         | :x:                | `2` on JDK < 21, `jlink` default on newer ones                                                                                                     | Compression level used by `jlink` when generating a customized JRE (`0`, `1` or `2` up to JDK 20, `zip-0` to `zip-9` since JDK 21). No compression means smaller zipballs and installers. |
